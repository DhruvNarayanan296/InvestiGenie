...
selected_stocks = st.sidebar.text_input('Enter Stock Ticker (e.g., AAPL, MSFT or TSLA)').upper()
...
if selected_stocks:
        ...
        # Add a new tab for Educational Resources
            ...
            **Disclaimer**: The educational content provided here is for informational purposes only and should not be considered as financial advice. Always consult with a professional financial advisor before making any investment decisions.
            ...
            def main():
                ...
                username = st.text_input("Please enter your password or create one to get started with the Virtual Trading Platform:")
    ...
    st.info("Please enter a stock ticker from the NYSE to get started.")
